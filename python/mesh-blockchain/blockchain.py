...
class Blockchain:
    ...
    def __init__(self, public_key, node_id):
        ...
        # Databases
        # self.__open_transactions_db = TinyDB(f'data/{node_id}/ot.json')
        # self.__peer_nodes_db = TinyDB(f'data/{node_id}/nodes.json')
        # self.__chain_db = TinyDB(f'data/{node_id}/chain.json')
    ...
    def load_data(self):
        ...
        try:
            with open('data/{}/chain.json'.format(self.node_id), mode='r') as f:
            ...
            with open('data/{}/transactions.json'.format(self.node_id), mode='r') as f:
            ...
            with open('data/{}/peers.json'.format(self.node_id), mode='r') as f:
    ...
    def save_data(self):
        ...
        try:
            with open('data/{}/chain.json'.format(self.node_id), mode='w') as f:
                saveable_chain = [
            ...
            with open('data/{}/transactions.json'.format(self.node_id), mode='w') as f:
                saveable_tx = [tx.__dict__ for tx in self.__open_transactions]
                json.dump(saveable_tx, f)

            with open('data/{}/peers.json'.format(self.node_id), mode='w') as f:
                json.dump(list(self.__peer_nodes), f)
    ...
    def add_peer_node(self, node):
        ...
        """
        if node in f"http://localhost:{self.node_id}/":
            # do not add self
            return
